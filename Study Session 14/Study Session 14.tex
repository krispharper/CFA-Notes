...
\begin{flashcard}[\studyArea]{Issues with Costs of Strategic Currency Risk Management}
    \begin{itemize}
        ...
        \item Forward currency contracts are often shorting than the hedging period, so they require FX swaps. This creates cash flow volatility from gains and losses on the contracts.
...
\begin{flashcard}[\studyArea]{Minimum-variance Hedge Ratio}
    \begin{flushleft}
        A mathematical approach to determining hedge ratio. It's a regression of the past changes in the value of the portfolio ($R_{\text{DC}}$) to the past changes in the value of the hedging instrument. The hedge ration is the beta (slope) of this regression. It minimizes tracking error.
    \end{flushleft}
\end{flashcard}
