...
\begin{flashcard}[\studyArea]{Three Level Approach to Permissible Research}
    \begin{enumerate}[Level I]
        \item \textbf{Define the Product or Service.} Define it in detail, including multiple components. Answer the question, ``What is paid for with soft dollars?''
        \item \textbf{Determine Usage.} Determine the primary use of the product or service. For example, does the Bloomberg service received directly assist in the investment decision-making process, or is it there just to provide an ``overall benefit to the firm''?
        \item \textbf{Mixed Use Analysis.} This step must be completed only if the product or service is classified as ``research'' based on the Level I and Level II analysis above. This Level III analysis is the investment manager's allocation of the proportion of the product or service which directly assists in the investment decision making process. For example, if the Bloomberg service is used 50\% of the time to ``determine the market and industry trends as part of the investment manager's investment decision-making process,'' then half of the expense can be paid from client brokerage.
    \end{enumerate}
\end{flashcard}

\begin{flashcard}[\studyArea]{Research and Objectivity Standards Requirements 1-4}
    \begin{enumerate}
        \item \textbf{Research Objectivity Policy.} The firm must have:
            \begin{itemize}
                \item A formal written independence and objectivity research policy that it distributes to clients, prospective clients, and employers.
                \item Supervisory procedures so that employees comply with the policy.
                \item A senior officer who attest annually to clients and prospective clients that the firm has complied with the policy.
            \end{itemize}
        \item \textbf{Public Appearances.} Covered employees who make public appearances to discuss research or investment recommendations must disclose any personal and firm conflicts of interest.
        \item \textbf{Reasonable and Adequate Basis.} Research reports and investment recommendations must have a reasonable and adequate basis. Either a single employee or a committee must be charged with reviewing and approving all research reports and investment recommendations.
        \item \textbf{Investment Banking.} Firms with investment banking operations must have in place policies and procedures that:
            \begin{itemize}
                \item Separate research analysts from the investment banking departments.
                \item Analysts don't report to and are not supervised by investment bankers.
                \item Prevent the investment banking department from reviewing, revising, or approving research reports and investment recommendations.
            \end{itemize}
    \end{enumerate}
\end{flashcard}

\begin{flashcard}[\studyArea]{Research and Objectivity Standards Requirements 5-8}
    \begin{enumerate}
        \addtocounter{enumi}{4}
        \item \textbf{Research Analyst Compensation.} Compensation for research analysts should be directly related to the quality of the research and recommendations provided by the analyst and not directly linked to investment banking or corporate finance activities.
        \item \textbf{Relationships With Subject Companies.} Analysts must not allow the subject company, prior to publication, to see any part of the research report that might signal the analyst's recommendation or rating, or make any promises concerning a specific recommendation or rating.
        \item \textbf{Personal Investments and Trading.} The firm must institute policies and procedures that
            \begin{itemize}
                \item Address the personal trading of covered employees.
                \item Ensure covered employees do not share information with anyone who could use that information to trade ahead (i.e., front running) of client trades.
                \item Prohibit covered employees and immediate family members from buying or receiving shares of subject companies or companies in the industry the employee covers prior to an IPO.
            \end{itemize}
        \item \textbf{Timeliness of Research Reports and Recommendations.} Regularly issue research reports on subject companies on a timely basis.
    \end{enumerate}
\end{flashcard}

\begin{flashcard}[\studyArea]{Research and Objectivity Standards Requirements 8-11}
    \begin{enumerate}
        \addtocounter{enumi}{8}
        \item \textbf{Compliance and Enforcement.} Firms must enforce their policies and compliance procedures, assess disciplinary sanctions on employees who violate the policies, monitor the effectiveness of the compliance procedures, and maintain records of any internal audits of the policies.
        \item \textbf{Disclosure.} The firm must disclose conflicts of interest related to covered employees or the firm as a whole.
        \item \textbf{Rating System.} The firm must have a rating system that investors find useful for investment decisions and provides investors with information they can use to determine the suitability of specific investments for their own portfolios.
    \end{enumerate}
\end{flashcard}

\begin{flashcard}[\studyArea]{Five Basic Principles of the ``New'' Prudent Investor Rule}
    \begin{itemize}
        \item Diversification is expected of portfolio managers as a method of reducing risk.
        \item Trustees must base an investment's appropriateness on is risk/return profile in a portfolio.
        \item Excessive trade (churning), as well as excessive fees and other transactions costs that are not warranted by the portfolio risk/return objectives, should be avoided.
        \item Current income for the trust must be balanced against the need for growth.
        \item Trustees are allowed (and may be required under certain circumstances) to delegate investment authority.
    \end{itemize}
\end{flashcard}

\begin{flashcard}[\studyArea]{General Soft Dollar Standards Requirements}
    \begin{itemize}
        \item Soft dollar practices must benefit the client and must place the clients' interest above the investment manager's interests.
        \item Allocation of client brokerage must not be based on the amount of client referrals the investment manager receives from a broker.
        \item Regarding mutual funds, the investment manager's client is the fund.  The fund's board should set policies regarding broker selection.
    \end{itemize}
\end{flashcard}

\begin{flashcard}[\studyArea]{Soft Dollar Standards Requirements for Relationships with Clients}
    \begin{itemize}
        \item Disclose to the client that the manager may participate in soft dollar arrangements involving the client's account prior to participating in such arrangements.
    \end{itemize}
\end{flashcard}

\begin{flashcard}[\studyArea]{Selection of brokers}
    \begin{itemize}
        \item Consider trade execution capabilities when selecting brokers.
        \item Proper broker selection is a key area where the investment manager can add value for the client.  Failure to obtain best execution will hurt performance.
    \end{itemize}
\end{flashcard}

\begin{flashcard}[\studyArea]{Soft Dollar Standards Requirements for Evaluation of Research}
    \begin{itemize}
        \item Research must meet the definition.  Research is defined as services and products provided by a broker whose primary use directly assists the investment manager in the investment decision-making process, and not in the management of the firm.
        \item Research must benefit the client.
        \item The basis for the determination must be documented.
        \item In the case of principal trades not subject to other fiduciary regulations, the research may benefit other client accounts, as long as disclosure is made to the client and prior permission is received.
        \item If the criteria regarding client brokerage associated with principal trades is not met, the investment manager must pay for the research.
        \item In the case of mixed use research, make a reasonable allocation of the cost of the research based on its expected usage.  Only portions that are used by the investment manager in the investment decision-making process can be paid with client brokerage.  Mixed use research allocation must be reevaluated annually.
    \end{itemize}
\end{flashcard}

\begin{flashcard}[\studyArea]{Soft Dollar Standards Requirements for Client-Directed Brokerage}
    \begin{itemize}
        \item Do not use brokerage from another client to products or services purchased under any client-directed brokerage agreement.
        \item Brokerage is an asset of the client, so the practice of client-directed brokerage does not violate the investment manager's duty.
    \end{itemize}
\end{flashcard}

\begin{flashcard}[\studyArea]{Soft Dollar Standards Requirements for Disclosure}
    \begin{itemize}
        \item Investment managers must disclose in plain language their soft dollar policies. Principal trades must be addressed.
        \item Investment managers must disclose the type of research received through proprietary or third-party research, the extent of its use, and whether an affiliated broker is involved.
        \item To claim compliance with Soft Dollar Standards, the client must receive as statement that soft dollar practices conform to these standards, and the statement must be provided at least annually.
        \item Investment managers must disclose to clients, prominently and in writing, that more information concerning soft dollar arrangements is available on request.
        \item Additional information provided upon request may include a description of what the firm obtained through its soft dollar arrangements, the brokers who provided services, and total commissions generated for the client's account.
    \end{itemize}
\end{flashcard}

\begin{flashcard}[\studyArea]{Soft Dollar Standards Requirements for Record Keeping}
    \begin{itemize}
        \item Meet legal and regulatory requirements.
        \item Are needed to supply timely information to clients consistent with the disclosure requirements.
        \item Document any arrangements that obligate the investment manager to generate a specific amount of brokerage.
        \item Document arrangements with clients regarding soft dollar or client-directed brokerage.
        \item Documents any broker arrangements.
        \item Document the basis for allocations when using client brokerage for mixed use services and products.
        \item Show compliance with the CFA Institute Soft Dollar Standards and identify the personnel responsible.
        \item Include copies of client disclosures and authorizations.
    \end{itemize}
\end{flashcard}
\end{document}
