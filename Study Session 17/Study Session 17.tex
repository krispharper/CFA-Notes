        ...
        \item \textbf{Micro attribution}
            \begin{itemize}
                ...
                \item Weaknesses
                    ...
                    \begin{itemize}
                        \item Needs and appropriate benchmark with securities and weights at beginning of evaluation period.
    ...
    \begin{itemize}[nosep]
        \item \textbf{Ex post alpha} is difference between actual return and return required to compensate for systematic risk, i.e., actual return and CAPM return.
            \begin{align*}
                ...
                %\text{where:}\\
                %\alpha_A &= \text{ex post alpha on the account}\\
                %R_{A_t} &= \text{actual return in period $t$}\\
                %\hat{R}_A &= \text{return predicted by CAPM}\\
            \end{align*}
