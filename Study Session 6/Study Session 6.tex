...
\begin{flashcard}[\studyArea]{Allocation of Cash Instruments and Credit Risk-Free Bonds}
    \begin{flushleft}
        ...
        Most common credit risk-free bonds are issued by governments in developed countries. Yield is composed of a real yield and expected inflation. If the time horizon is short, cyclical and short-term interest rate changes are important. Higher expected economic growth results in higher yields. Changes in short-term rates have less predictable effects.
    \end{flushleft}
\end{flashcard}
\end{document}
