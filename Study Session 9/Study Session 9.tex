...
\newcommand{\studyArea}{Management of Fixed Income Portfolios}
...
\begin{flashcard}[\studyArea]{Active Return and Tracking Risk}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Advantages and Disadvantages of Bond Portfolio Management Strategies}
...
\begin{flashcard}[\studyArea]{Four Criteria for Selecting a Benchmark Bond Index}
    \begin{enumerate}
...
\begin{flashcard}[\studyArea]{Stratified Sampling}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Risk Factors Used in Bond Benchmark Multifactor Models}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Present Value Distribution of Cash Flows}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Classical Immunization}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Immunization of a Single Liability}
    \begin{enumerate}
...
\begin{flashcard}[\studyArea]{Bond Characteristics to Consider When Immunizing}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Immunization Risk}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Effective Duration of a Portfolio}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Dollar Duration}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Steps to Adjust a Portfolio's Dollar Duration}
    \begin{enumerate}
...
\begin{flashcard}[\studyArea]{Three Spread Duration Measures for Fixed-rate Bonds}
    \begin{enumerate}
...
\begin{flashcard}[\studyArea]{Four Extensions to Classical Immunization}
    \begin{enumerate}
...
\begin{flashcard}[\studyArea]{Contingent Immunization}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Three Risks Associated with Managing Against a Liability Structure}
    \begin{enumerate}
...
\begin{flashcard}[\studyArea]{Maturity Variance}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Three Conditions for Multiple Liability Immunization}
    \begin{flushleft}
        \begin{enumerate}
...
\begin{flashcard}[\studyArea]{Cash Flow Matching}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Differences Between Cash Flow Matching and Multiple-liability Immunization}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Combination Matching}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Cyclical and Secular Changes}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Liquidity in the Bond Market}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Rationales for Secondary Market Bond Trading}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{General Rules for Buying Bonds Based on Duration and Interest Rates}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Three Different Yield Spread Measures}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Three Different Types of Spread Analysis}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Structural Analysis}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Analysis of Bonds with Early Retirement Provisions}
    \begin{itemize}
...
\begin{flashcard}[\studyArea]{Credit Analysis}
    \begin{flushleft}
...
\begin{flashcard}[\studyArea]{Summary of Relative Valuation Methodologies}
    \begin{tabular}
       {>{\raggedright}p{1in}
        >{\raggedright}p{1.6in}
...
\begin{flashcard}[\studyArea]{Rationales for Not Trading}
    \begin{itemize}
