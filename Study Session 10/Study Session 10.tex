...
\begin{flashcard}[Fixed Income]{Effects of Leverage on Variability of Returns}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Repurchase Agreement}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Four Repo Delivery Scenarios}
    \begin{enumerate}
...
\begin{flashcard}[Fixed Income]{Factors Affecting the Repo Rate}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Disadvantages of Standard Deviation and Variance}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Semivariance, Shortfall Risk and Value at Risk}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Cheapest to Deliver}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Advantages of Futures Over Cash Market Instruments}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{How to Use Futures to Change Dollar Duration}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Dollar Duration Hedging Formula}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Basis Risk}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Cross Hedge}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Hedge Ratio for Cross Hedges}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Yield Beta}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Three Basic Sources of Hedging Error}
    \begin{enumerate}
...
\begin{flashcard}[Fixed Income]{Formula for the Duration of a Bond Option}
    \begin{flushleft}
        \[
...
\begin{flashcard}[Fixed Income]{Protective Put and Covered Call}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Three Types of Credit Risk}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Three Types of Credit Derivative Instruments}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Sources of Excess Return on International Bonds}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Country Beta}
    \begin{flushleft}
...
\begin{flashcard}[Fixed Income]{Interest Rate Parity}
    \begin{flushleft}
        \begin{align*}
...
\begin{flashcard}[Fixed Income]{Methods of Hedging Currency Risk for International Bonds}
    \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Advantages and Disadvantages of Investing in Emerging Market Debt}
    \begin{itemize}
        \item Advantages
            \begin{itemize}
...
\begin{flashcard}[Fixed Income]{Criteria to Determine the Optimal Mix of Active Managers}
    \begin{itemize}
