...
\begin{flashcard}[Alternative Investments]{Effects of Adding Distressed Securities to an Existing Portfolio}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Advantages and Disadvantages to Direct Real Estate Investment}
    \begin{itemize}
        \item Advantages
        \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Types of Venture Capital Investors}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Stages of Venture Capitalized Companies}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Differences Between Venture Capital and Buyout Funds}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Use of Convertible Preferred Stock in Venture Capital Investment}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Private Equity Funds}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Concerns for Private Equity Investment Strategies}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Direct Versus Indirect Commodity Investment}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Three Components of Return for a Commodity Futures Contract}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Commodities as an Inflation Hedge}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Classifications of Hedge Funds by Strategy}
...
\begin{flashcard}[Alternative Investments]{Classifications of Hedge Funds by Segment}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Fee Structure of Hedge Funds}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Fund of Funds Hedge Funds}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Issues Concerning Hedge Fund Performance Evaluation}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Downside Deviation}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Limitations of Using Sharpe Ratio for Hedge Funds}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Trading Strategies of Managed Futures Programs}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Managed Futures Role in a Portfolio}
    \begin{flushleft}
...
\begin{flashcard}[Alternative Investments]{Strategies for Distressed Securities Investing}
    \begin{itemize}
...
\begin{flashcard}[Alternative Investments]{Risks Associated with Distressed Securities Investing}
    \begin{itemize}
